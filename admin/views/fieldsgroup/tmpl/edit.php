...
<form name="adminForm" method="post" action="index.php?option=<?php echo $this -> option;?>&view=<?php echo $this -> view;?>">
        ...
        <fieldset class="adminform">
            ...
            <table class="admintable">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <input type="text"
                               maxlength="50"
                               size="50"
                               value="<?php echo $this -> listsEdit -> name?>"
                               id="name"
                               name="name">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <?php echo $this -> editor -> display('description',htmlspecialchars($this -> listsEdit -> description,ENT_QUOTES),'500', '300', '60', '20', array('pagebreak', 'readmore'));?>
                    </td>
                </tr>
                <tr>
                    <td class="key" valign="top">
                        <label width="100" for="id">
                            <strong><?php echo JText::_('JGRID_HEADING_ID')?>:</strong>
                        </label>
                    </td>
                    <td>
                        <?php echo $this -> listsEdit -> id;?>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <input type="hidden" value="<?php echo $this -> listsEdit -> id;?>" name="cid[]">
