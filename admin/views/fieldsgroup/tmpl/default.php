...
<form name="adminForm" id="adminForm" method="post" action="index.php?option=com_tz_portfolio">
        ...
        <table class="table table-striped">
            ...
            <tr class="row<?php echo ($i%2==1)?'1':$i;?>" sortable-group-id="<?php echo $item -> id;?>">
                ...
                <td class="nowrap has-context">
                    <div class="pull-left">
                        <a href="index.php?option=com_tz_portfolio&amp;view=fieldsgroup&amp;task=edit&amp;id=<?php echo $item -> id;?>">
                            <?php echo $item -> name;?>
                        </a>
                    </div>
                    <div class="pull-left">
                        <?php
                            ...
                            JHtml::_('dropdown.edit', $item->id, '','index.php?option=com_tz_portfolio&amp;view=fieldsgroup');
