...
<form id="adminForm" name="adminForm" method="post"
    ...
    <div class="control-group">
        <div class="control-label">
            <?php echo $this -> form -> getLabel('tz_image_xsmall');?>
        </div>
        <div class="controls">
            <?php echo $this -> form -> getInput('tz_image_xsmall');?>
        </div>
    </div>
    <div class="control-group">
        <div class="control-label">
            <?php echo $this -> form -> getLabel('tz_image_small');?>
        </div>
        <div class="controls">
            <?php echo $this -> form -> getInput('tz_image_small');?>
        </div>
    </div>
    <div class="control-group">
        <div class="control-label">
            <?php echo $this -> form -> getLabel('tz_image_medium');?>
        </div>
        <div class="controls">
            <?php echo $this -> form -> getInput('tz_image_medium');?>
        </div>
    </div>
    <div class="control-group">
        <div class="control-label">
            <?php echo $this -> form -> getLabel('tz_image_large');?>
        </div>
        <div class="controls">
            <?php echo $this -> form -> getInput('tz_image_large');?>
        </div>
    </div>
    <div class="control-group">
        <div class="control-label">
            <?php echo $this -> form -> getLabel('tz_image_xlarge');?>
        </div>
        <div class="controls">
            <?php echo $this -> form -> getInput('tz_image_xlarge');?>
        </div>
    </div>
