...
class JFormFieldModal_Category extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html = array();
		$link = 'index.php?option=com_tz_portfolio&amp;view=categories&amp;layout=modal&amp;tmpl=component&amp;extension=' . $extension . '&amp;function=jSelectCategory_' . $this->id;
		...
		if ($allowEdit)
		{
			$html[] = '<a class="btn hasTooltip' . ($value ? '' : ' hidden') . '" href="index.php?option=com_tz_portfolio&layout=modal&tmpl=component&task=category.edit&id=' . $value . '" target="_blank" title="' . JHtml::tooltipText('COM_CATEGORIES_EDIT_CATEGORY') . '" ><span class="icon-edit"></span> ' . JText::_('JACTION_EDIT') . '</a>';
		}
