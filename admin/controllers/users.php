 ...
 */
class TZ_PortfolioControllerUsers extends JControllerAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'User', $prefix = 'TZ_PortfolioModel', $config = array('ignore_request' => true))
	{
	...
	public function changeBlock()
	{
		...
		$this->setRedirect('index.php?option=com_tz_portfolio&view=users');
	}
