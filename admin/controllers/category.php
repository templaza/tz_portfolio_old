 ...
 */
class TZ_PortfolioControllerCategory extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect('index.php?option=com_tz_portfolio&view=categories&extension=' . $this->extension);
    ...
    function extrafields(){
        $model  = $this -> getModel('Category','TZ_PortfolioModel');
