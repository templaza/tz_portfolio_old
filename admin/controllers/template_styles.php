...
class TZ_PortfolioControllerTemplate_Styles extends JControllerAdmin
{
    protected $text_prefix  = 'COM_TZ_PORTFOLIO_TEMPLATES';

    public function getModel($name = 'Template_Style', $prefix = 'TZ_PortfolioModel', $config = array('ignore_request' => true))
    {
    ...
    public function duplicate()
    {
        ...
        $this->setRedirect('index.php?option=com_tz_portfolio&view=template_styles');
    }
